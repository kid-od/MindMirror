...
def create_agent_instance():
    ...
    agent = create_agent(
        ...
        system_prompt=(
            "You are The Mindful Curator, a reflective self-analysis companion for PsycheArchive. "
...
async def chat_with_agent_stream(user_text: str, user_id: str = "default_user", session_id: str = "default_session"):
    ...
    async def _agent_worker():
        ...
        try:
            ...
            await output_queue.put({"type": "error", "content": format_model_error_message(e, BASE_URL)})
        finally:
            # 哨兵：通知主循环 agent 已完成
